        ...
        slivers: <Widget>[
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Center(
                child: Text(
                  'Berikut jadwal rencana pelaksanaan penerimaan siswa baru tingkat SD dan SMP di lingkup Dinas Pendidikan dan Kebudayaan Kota Pangkalpinang.',
                  style: TextStyle(
          ...
          SliverPadding(
            padding:
                const EdgeInsets.only(top: 20, bottom: 40, right: 20, left: 20),
            sliver: SliverList(
                        ...
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                  ...
                                  blurRadius: 12,
                                  spreadRadius: 0,
                                  color: ColorPallete.black20.withOpacity(0.6))
                            ],
                            borderRadius: BorderRadius.circular(8),
                            border: Border.all(
                                color: ColorPallete.lightBlue, width: 1)),
                        child: Column(
                          children: <Widget>[
                            ExpandablePanel(
