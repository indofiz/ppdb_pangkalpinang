          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text(
                  'PPDB Kota Pangkalpinang Tahun 2023',
                  style: TextStyle(
                    ...
                    Flexible(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: ColorPallete.lightBlue, width: 2),
                              boxShadow: [
                                BoxShadow(
                                    blurRadius: 16,
                                    color: ColorPallete.black20,
                          ...
                          child: TextButton(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                    height: 80,
                                    child: Image.asset('assets/images/sd.png')),
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                    height: 80,
                                    child:
                                        Image.asset('assets/images/smp.png')),
                                const SizedBox(height: 8),
                                Text(
                                  'Zona SMP',
                                  style: TextStyle(
              ...
              MylistInfoNav(
                icon: Icons.list_alt,
                text: 'Daftar Sekolah Perzona SD',
                onPress: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const DaftarZonaSD()),
                  );
                },
              ),
              MylistInfoNav(
                icon: Icons.list_alt,
                text: 'Daftar Sekolah Perzona SMP',
                onPress: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const DaftarZonaSMP()),
                  );
                },
              ),
            ],
