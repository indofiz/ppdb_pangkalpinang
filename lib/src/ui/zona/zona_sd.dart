...
class _ZonaSDState extends State<ZonaSD> {
  final _urlEbbok =
      'https://ppdb.pangkalpinangkota.go.id/MANUAL_BOOK_PPDB_ONLINE_DIKBUD_2022.pdf';
            ...
            child: Container(
              ...
              child: Column(children: [
                MylistInfo(
                  ...
                  text: 'Panduan Video PPDB',
                  onPress: _urlVideo,
                ),
                MylistInfo(
                  icon: Icons.menu_book,
                  text: 'Panduan Manual Book PPDB SD',
                  onPress: _urlEbbok,
                ),
              ...
              delegate: SliverChildBuilderDelegate(
                (context, index) {
                  return Container(
                    ...
                    child: TextButton(
                      onPressed: () async {
                        _launchURL(listZonaSD[index].link);
                      },
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(listZonaSD[index].kecamatan,
                                style: TextStyle(
