      ...
      body: CustomScrollView(
          slivers: <Widget>[
            SliverAppBar(
              ...
              snap: true,
              floating: true,
              title: Text('ZONA SMP',style: TextStyle(color: ColorPallete.blackPurple,fontWeight: FontWeight.w900,fontSize: 24)),
              centerTitle: true,
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(children: [
                  ...
                  MylistInfo(icon: Icons.location_on, text: 'Panduan Manual Book PPDB SMP 2022',onPress: _urlEbbok,),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(listZonaSmp[index].title,style: TextStyle(color: ColorPallete.black100,fontSize: 16,fontWeight: FontWeight.w600),textAlign: TextAlign.center),
                              const  SizedBox(height: 4,),
                              Text(listZonaSmp[index].kecamatan,style: TextStyle(color: ColorPallete.black60,fontSize: 12,fontWeight: FontWeight.w400),textAlign: TextAlign.center)
                            ],
                          ),
                        ),
                        ),
